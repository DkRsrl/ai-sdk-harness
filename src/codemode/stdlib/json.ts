...
import type { CallbackRunner } from "../interpreter/methods"
import { applyCollectionCallback } from "../interpreter/methods"
import { type AstNode, InterpreterRuntimeError } from "../interpreter/model"
import { typeofValue } from "../interpreter/references"
import { copyIn, copyOut, type SafeObject } from "../tool-runtime"
import {
  CodeModeDate,
  CodeModeMap,
  CodeModeRegExp,
